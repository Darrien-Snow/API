...
public class Output_Pojo_Login_Data {
	public int id;
	...
	public ArrayList<Output_Pojo_Login_UserRole> user_role;
	...
	public ArrayList<Output_Pojo_Login_UserRole> getUser_role() {
		return user_role;
	}

	public void setUser_role(ArrayList<Output_Pojo_Login_UserRole> user_role) {
